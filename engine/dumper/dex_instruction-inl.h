...
#ifndef _ART_DEX_INSTRUCTION_INL_H_
#define _ART_DEX_INSTRUCTION_INL_H_
...
inline void Instruction::GetVarArgs(uint32_t arg[5], uint16_t inst_data) const
{
    ...
    CHECK_LE(count, 5U) << "Invalid arg count in 35c (" << count << ")";
